...
export const metadata: Metadata = {
  title: 'Cirugía SMILE en Contreras | Dr. César Sánchez Galeana | Optall Vision',
  description: 'Cirugía SMILE cerca de La Magdalena Contreras, CDMX. Clínica en Periférico Sur, a 10 minutos. Dr. César Sánchez Galeana, 28 años de experiencia.',
  keywords: 'smile contreras, cirugia ojos contreras, oftalmologos contreras, lasik contreras, cirugia refractiva magdalena contreras cdmx',
  alternates: {
    canonical: `${SITE_CONFIG.url}/zona-sur/smile-contreras`,
  },
}

const contrerasFaqs = [
  {
    question: '¿Dónde está ubicada la clínica respecto a Contreras?',
    answer: `Estamos en Periférico Sur 3332, Piso 11, en Jardines del Pedregal. A solo 10 minutos de La Magdalena Contreras por Periférico Sur o Luis Cabrera. Muy accesible desde San Jerónimo.`,
  },
  {
  ...
  {
    question: '¿Cómo llego desde Contreras?',
    answer: 'La ruta más directa es por Luis Cabrera hasta Periférico Sur, luego hacia el norte. También puedes bajar por Av. San Jerónimo. Desde el centro de Contreras son aproximadamente 10 minutos sin tráfico.',
  },
  {
...
export default function SmileContrerasPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'SMILE Contreras', url: `${SITE_CONFIG.url}/zona-sur/smile-contreras` },
        ]}
      />
      <LocalBusinessSchema neighborhood="contreras" areaName="La Magdalena Contreras" />
      <FAQPageSchema faqs={contrerasFaqs} />
      ...
      <section className="bg-gradient-to-br from-green-50 to-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-gray-500 mb-8">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900">SMILE Contreras</span>
          </nav>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-block bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium mb-4">
                📍 A 10 min de Contreras
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
                Cirugía <span className="text-blue-600">SMILE</span> cerca de Contreras
              </h1>
              <p className="mt-4 text-xl text-gray-600">
                La clínica de cirugía refractiva más cercana para residentes de La Magdalena Contreras.
            ...
            <div className="bg-gray-100 rounded-2xl p-6">
              ...
              <div className="bg-white rounded-lg p-4 mb-4">
                ...
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Contreras Centro: 10 min en auto</li>
                  <li>• San Jerónimo Lídice: 5 min en auto</li>
                  <li>• La Malinche: 12 min en auto</li>
                  <li>• San Bernabé: 15 min en auto</li>
                </ul>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            ¿Por qué elegirnos desde Contreras?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              <div className="text-4xl mb-4">🏥</div>
              <h3 className="text-xl font-semibold mb-2">La Más Cercana</h3>
              <p className="text-gray-600">
                Somos la clínica de cirugía SMILE más accesible para 
                residentes de Contreras. Sin cruzar la ciudad.
              </p>
            </div>
            <div className="text-center p-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Colonias de Contreras que atendemos
          </h2>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Preguntas frecuentes - Contreras
          </h2>
          <div className="max-w-3xl mx-auto">
            <FAQAccordion faqs={contrerasFaqs} />
          </div>
        </div>
      </section>
