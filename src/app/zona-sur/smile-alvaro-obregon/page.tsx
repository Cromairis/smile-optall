...
import { SITE_CONFIG, DOCTOR_INFO, BUSINESS_INFO, EQUIPMENT } from '@/lib/constants'

export const metadata: Metadata = {
  title: 'Cirugía SMILE en Álvaro Obregón | Dr. César Sánchez Galeana | Optall Vision',
  description: 'Cirugía SMILE cerca de Álvaro Obregón, CDMX. Clínica en Periférico Sur, a 8-12 minutos. Dr. César Sánchez Galeana, 28 años de experiencia, +15,000 cirugías.',
  keywords: 'smile alvaro obregon, cirugia ojos alvaro obregon, oftalmologos alvaro obregon, lasik alvaro obregon, cirugia refractiva alvaro obregon cdmx',
  alternates: {
    canonical: `${SITE_CONFIG.url}/zona-sur/smile-alvaro-obregon`,
  },
}

const alvaroObregonFaqs = [
  {
    question: '¿Dónde está ubicada la clínica respecto a Álvaro Obregón?',
    answer: `Estamos en Periférico Sur 3332, Piso 11, en Jardines del Pedregal. A solo 8-12 minutos de las principales colonias de Álvaro Obregón como Mixcoac, San Ángel, Florida y Guadalupe Inn.`,
  },
  {
  ...
  {
    question: '¿Cómo llego desde Álvaro Obregón?',
    answer: 'La ruta más directa es por Periférico Sur si vienes de Mixcoac o Revolución. Desde San Ángel puedes tomar Revolución hacia el sur hasta conectar con Periférico. Desde Santa Fe, toma Periférico hacia el sur.',
  },
  {
...
export default function SmileAlvaroObregonPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'SMILE Álvaro Obregón', url: `${SITE_CONFIG.url}/zona-sur/smile-alvaro-obregon` },
        ]}
      />
      <LocalBusinessSchema neighborhood="alvaro-obregon" areaName="Álvaro Obregón" />
      <FAQPageSchema faqs={alvaroObregonFaqs} />
      ...
      <section className="bg-gradient-to-br from-green-50 to-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-gray-500 mb-8">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900">SMILE Álvaro Obregón</span>
          </nav>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-block bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium mb-4">
                📍 A 8-12 min de Álvaro Obregón
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
                Cirugía <span className="text-blue-600">SMILE</span> en Álvaro Obregón
              </h1>
              <p className="mt-4 text-xl text-gray-600">
                La clínica de cirugía refractiva ideal para residentes de Álvaro Obregón.
            ...
            <div className="bg-gray-100 rounded-2xl p-6">
              ...
              <div className="bg-white rounded-lg p-4 mb-4">
                ...
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Mixcoac: 8 min en auto</li>
                  <li>• San Ángel: 8 min en auto</li>
                  <li>• Florida: 6 min en auto</li>
                  <li>• Guadalupe Inn: 5 min en auto</li>
                </ul>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            ¿Por qué elegirnos desde Álvaro Obregón?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              <div className="text-4xl mb-4">🏥</div>
              <h3 className="text-xl font-semibold mb-2">Ubicación Estratégica</h3>
              <p className="text-gray-600">
                Sobre Periférico Sur, accesible desde cualquier punto de 
                Álvaro Obregón sin cruzar la ciudad.
              </p>
            </div>
            <div className="text-center p-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Colonias de Álvaro Obregón que atendemos
          </h2>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Preguntas frecuentes - Álvaro Obregón
          </h2>
          <div className="max-w-3xl mx-auto">
            <FAQAccordion faqs={alvaroObregonFaqs} />
          </div>
        </div>
      </section>
